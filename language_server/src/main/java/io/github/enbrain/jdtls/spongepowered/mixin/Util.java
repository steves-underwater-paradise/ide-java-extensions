...
public final class Util {
	...
	public static final Set<String> INJECTORS = Set.of("org.spongepowered.asm.mixin.injection.Inject", "org.spongepowered.asm.mixin.injection.ModifyArg",
			"org.spongepowered.asm.mixin.injection.ModifyArgs", "org.spongepowered.asm.mixin.injection.ModifyConstant", "org.spongepowered.asm.mixin.injection.ModifyVariable",
			"org.spongepowered.asm.mixin.injection.Redirect", "com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation", "com.llamalad7.mixinextras.injector.ModifyExpressionValue",
			"com.llamalad7.mixinextras.injector.ModifyReceiver", "com.llamalad7.mixinextras.injector.ModifyReturnValue", "com.llamalad7.mixinextras.injector.WrapWithCondition");
	...
	public static final List<String> INJECTION_POINT_TYPES = List.of("HEAD", "RETURN", "TAIL", "INVOKE", "INVOKE_STRING", "INVOKE_ASSIGN", "FIELD", "NEW", "JUMP", "CONSTANT");

	private Util() {
		// NO-OP
	}

	public static @NotNull String getJavaVersion() {
		return JavaCore.getJavaCore().toString();
	}

	public static Annotation getAnnotationFromMember(ASTNode node, String member) {
		if (node instanceof MemberValuePair pair && pair.getName().getIdentifier().equals(member) && pair.getParent() instanceof NormalAnnotation annotation) {
			return annotation;
		}
